...
function applyOutfitAccessory(accessory) {
    ...
    if (!outfitImage || !outfitImage.src || !canvas || !processedContainer || !originalImg) {
        ...
        canvas.toBlob(function(blob) {
            ...
            .then(data => {
                ...
                if (data.image) {
                    ...
                    showErrorMessage('Failed to apply accessory', 3000);
                }
            })
            .catch(error => {
                console.error('Error applying accessory:', error);
                showErrorMessage('Error applying accessory. Is the server running?', 3000);
    ...
    img.onerror = function() {
        ...
        showErrorMessage('Error loading outfit image', 3000);
    ...
    img.src = originalOutfitImage || outfitImage.src;
}
